...
{ *inc+=5;
  ...
  *co_mo=*co_mo+1;
  ...
  outtextxy(500,285,"s -> Down");
  outtextxy(500,300,"a -> Left");
  outtextxy(500,315,"d -> Right");
}
...
void caption()
{
  setcolor(12);
  settextstyle(0,HORIZ_DIR,0);
  outtextxy(10,75,"Press 'SPACE' to EXIT");
  setcolor(WHITE);
}
int level_1(int *p)
{
 ...
 outtextxy(150,150,"Maze Runner");
 settextstyle(0,HORIZ_DIR,2);
 setcolor(9);
 outtextxy(150,250,"Press 'space' to start the game");
  char ch=getch();
 if(ch==' ') break;
 getch();
  }
